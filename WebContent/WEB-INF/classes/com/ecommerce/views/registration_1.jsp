...
<html>
	...
	<body>
		...
		<div id="regForm">
			<form action="RegistrationController?step=1" method="post" name="registrationForm">
							...
							<fieldset>
								<table align="center" valign="top">
									<tr><td colspan="3"><div id="errorMsg" style="color: RED"><% 
										...
										if(errorMsg != null){
											...
											if(errorMsg.equals("2")){
												out.println("Passwords didn't matched.");
											}else{
												out.println("");
											}
										}
									...
									<tr>
										...
										String value3 = request.getParameter("confirmPassword");
										if(value3 == null)
											out.println("");
										else
											out.println(value3);
									...
									<tr><td>&nbsp;</td></tr>
									<tr>
										<td colspan="3" align="center"><input type="submit" name="submit" value="Next Step" /></td>
									</tr>
								</table>
							</fieldset>
						</td>
